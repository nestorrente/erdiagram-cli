...
CREATE TABLE "COUNTRY" (
    "ID" NUMBER NOT NULL DEFAULT "COUNTRY_ID_SEQ".nextval,
...
ALTER TABLE "USER" ADD CONSTRAINT "USER_COUNTRY_ID_FK" FOREIGN KEY ("COUNTRY_ID") REFERENCES "COUNTRY" ("ID");
ALTER TABLE "USER" ADD CONSTRAINT "USER_ALTERNATIVE_COUNTRY_ID_FK" FOREIGN KEY ("ALTERNATIVE_COUNTRY_ID") REFERENCES "COUNTRY" ("ID");
